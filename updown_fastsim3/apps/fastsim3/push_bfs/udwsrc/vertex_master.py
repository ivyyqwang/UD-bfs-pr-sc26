...
def EFA_vertex_master(efa):
  ...
  tranvertex_master__v_orig_return.writeAction(f"__if_v_orig_return_0_true: addi X7 X28 16384") 
  tranvertex_master__v_orig_return.writeAction(f"movwrl X17 X28(X23,0,0)") 
  tranvertex_master__v_orig_return.writeAction(f"addi X23 X27 1") 
  tranvertex_master__v_orig_return.writeAction(f"movwrl X15 X28(X27,0,0)") 
  tranvertex_master__v_orig_return.writeAction(f"sli X17 X28 6") 
  ...
  tranvertex_master__v_orig_return.writeAction(f"sendr2_dmlm_wret X28 vertex_master::v_neighs_return X18 X15 X27") 
  ...
  tranvertex_master__v_orig_return.writeAction(f"add X28 X27 X27") 
  tranvertex_master__v_orig_return.writeAction(f"__while_v_orig_return_3_condition: bleu X27 X28 __while_v_orig_return_5_post") 
  tranvertex_master__v_orig_return.writeAction(f"__while_v_orig_return_4_body: send_dmlm_ld_wret X28 vertex_master::v_neighs 8 X29") 
  ...
  tranvertex_master__v_orig_return.writeAction(f"__if_v_orig_return_2_post: sli X11 X27 6") 
  ...
  tranvertex_master__v_orig_return.writeAction(f"sendr2_dmlm_wret X27 vertex_master::v_neighs_return X18 X19 X28") 
  tranvertex_master__v_orig_return.writeAction(f"addi X22 X22 1") 
  tranvertex_master__v_orig_return.writeAction(f"addi X12 X28 0") 
  ...
  tranvertex_master__v_orig_return.writeAction(f"__while_v_orig_return_8_post: sli X17 X28 6") 
  ...
  tranvertex_master__v_orig_return.writeAction(f"add X27 X28 X29") 
  tranvertex_master__v_orig_return.writeAction(f"__while_v_orig_return_12_condition: bleu X29 X27 __while_v_orig_return_14_post") 
  tranvertex_master__v_orig_return.writeAction(f"__while_v_orig_return_13_body: send_dmlm_ld_wret X27 vertex_master::v_neighs 8 X28") 
  ...
  tranvertex_master__v_neighs.writeAction(f"__entry: addi X8 X27 0") 
  tranvertex_master__v_neighs.writeAction(f"movir X29 -1") 
  tranvertex_master__v_neighs.writeAction(f"bne X27 X29 __if_v_neighs_2_post") 
  ...
  tranvertex_master__v_neighs.writeAction(f"__if_v_neighs_3_true: movir X28 -1") 
  tranvertex_master__v_neighs.writeAction(f"sri X28 X28 1") 
  tranvertex_master__v_neighs.writeAction(f"sendr_wcont X20 X28 X24 X17") 
  ...
  tranvertex_master__v_neighs.writeAction(f"movir X28 0") 
  tranvertex_master__v_neighs.writeAction(f"evlb X28 map_master__add_vertex") 
  tranvertex_master__v_neighs.writeAction(f"evi X28 X28 255 4") 
  tranvertex_master__v_neighs.writeAction(f"ev X28 X28 X23 X23 8") 
  tranvertex_master__v_neighs.writeAction(f"sendr_wret X28 vertex_master::v_neighs_return X27 X17 X30") 
  tranvertex_master__v_neighs.writeAction(f"addi X9 X27 0") 
  tranvertex_master__v_neighs.writeAction(f"bne X27 X29 __if_v_neighs_8_post") 
  ...
  tranvertex_master__v_neighs.writeAction(f"bne X27 X29 __if_v_neighs_14_post") 
  ...
  tranvertex_master__v_neighs.writeAction(f"bne X27 X29 __if_v_neighs_20_post") 
  ...
  tranvertex_master__v_neighs.writeAction(f"bne X27 X29 __if_v_neighs_26_post") 
  ...
  tranvertex_master__v_neighs.writeAction(f"bne X27 X29 __if_v_neighs_32_post") 
  ...
  tranvertex_master__v_neighs.writeAction(f"bne X27 X29 __if_v_neighs_38_post") 
  ...
  tranvertex_master__v_neighs.writeAction(f"bne X27 X29 __if_v_neighs_44_post") 
  ...
  tranvertex_master__v_neighs.writeAction(f"evi X28 X28 255 4") 
  tranvertex_master__v_neighs.writeAction(f"ev X28 X28 X23 X23 8") 
  tranvertex_master__v_neighs.writeAction(f"sendr_wret X28 vertex_master::v_neighs_return X27 X17 X29") 
