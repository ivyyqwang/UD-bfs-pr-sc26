...
def EFA_main_master(efa):
  ...
  tranmain_master__init.writeAction(f"addi X8 X29 0")  # This is for casting. May be used later on
  tranmain_master__init.writeAction(f"add X28 X29 X29") 
  ...
  tranmain_master__init.writeAction(f"addi X15 X29 1") 
  tranmain_master__init.writeAction(f"movrl X29 56(X24) 0 8") 
  tranmain_master__init.writeAction(f"addi X10 X29 0") 
  ...
  tranmain_master__init.writeAction(f"mul X22 X25 X27") 
  tranmain_master__init.writeAction(f"add X27 X28 X27") 
  tranmain_master__init.writeAction(f"__while_init_9_condition: ble X27 X28 __if_init_5_post") 
  tranmain_master__init.writeAction(f"__while_init_10_body: movrl X29 16(X24) 0 8") 
  tranmain_master__init.writeAction(f"movir X30 0") 
  ...
  tranmain_master__init.writeAction(f"add X29 X26 X29") 
  ...
  tranmain_master__init.writeAction(f"sladdii X23 X25 1 43") 
  ...
  tranmain_master__send_to_global_master_thread.writeAction(f"sladdii X10 X25 1 43") 
  tranmain_master__send_to_global_master_thread.writeAction(f"movwlr X24(X25,0,0) X26") 
  tranmain_master__send_to_global_master_thread.writeAction(f"addi X26 X26 0")  # This is for casting. May be used later on
  ...
  tranmain_master__start.writeAction(f"addi X19 X25 0")  # This is for casting. May be used later on
  tranmain_master__start.writeAction(f"add X24 X25 X25") 
  tranmain_master__start.writeAction(f"__while_start_3_condition: ble X25 X24 __while_start_5_post") 
  tranmain_master__start.writeAction(f"__while_start_4_body: ev X26 X28 X24 X24 8") 
  tranmain_master__start.writeAction(f"movir X29 0") 
  tranmain_master__start.writeAction(f"evlb X29 map_master__send_to_map_master_thread") 
  tranmain_master__start.writeAction(f"evi X29 X29 255 4") 
  tranmain_master__start.writeAction(f"ev X29 X29 X24 X24 8") 
  tranmain_master__start.writeAction(f"sendr_wret X29 main_master::map_launcher_done X28 X8 X27") 
  ...
  tranmain_master__start.writeAction(f"mul X19 X22 X26") 
  tranmain_master__start.writeAction(f"addi X26 X26 0")  # This is for casting. May be used later on
  tranmain_master__start.writeAction(f"add X25 X26 X26") 
  tranmain_master__start.writeAction(f"__while_start_6_condition: ble X26 X25 __if_start_2_post") 
  tranmain_master__start.writeAction(f"__while_start_7_body: ev X24 X28 X25 X25 8") 
  tranmain_master__start.writeAction(f"movir X29 0") 
  tranmain_master__start.writeAction(f"evlb X29 main_master::send_to_global_master_thread") 
  tranmain_master__start.writeAction(f"evi X29 X29 255 4") 
  tranmain_master__start.writeAction(f"ev X29 X29 X25 X25 8") 
  tranmain_master__start.writeAction(f"addi X23 X27 1") 
  tranmain_master__start.writeAction(f"sendr3_wret X29 main_master::map_launcher_done X28 X17 X27 X30") 
  tranmain_master__start.writeAction(f"addi X22 X28 0")  # This is for casting. May be used later on
  tranmain_master__start.writeAction(f"add X25 X28 X25") 
  ...
  tranmain_master__map_launcher_done.writeAction(f"sri X20 X24 1") 
  tranmain_master__map_launcher_done.writeAction(f"print '[DEBUG][NWID %lu] <map_launcher_done> update_v:%lu' X0 X24") 
  ...
  tranmain_master__map_launcher_done.writeAction(f"movwlr X24(X26,0,0) X24") 
  ...
  tranmain_master__map_launcher_done.writeAction(f"sendr_wcont X24 X26 X20 X20") 
  ...
  tranmain_master__map_all_launched.writeAction(f"addi X19 X25 0")  # This is for casting. May be used later on
  tranmain_master__map_all_launched.writeAction(f"add X26 X25 X25") 
  tranmain_master__map_all_launched.writeAction(f"__while_map_all_launched_3_condition: ble X25 X26 __while_map_all_launched_5_post") 
  tranmain_master__map_all_launched.writeAction(f"__while_map_all_launched_4_body: ev X24 X28 X26 X26 8") 
  tranmain_master__map_all_launched.writeAction(f"movir X29 0") 
  tranmain_master__map_all_launched.writeAction(f"evlb X29 map_master__send_to_map_master_thread") 
  tranmain_master__map_all_launched.writeAction(f"evi X29 X29 255 4") 
  tranmain_master__map_all_launched.writeAction(f"ev X29 X29 X26 X26 8") 
  tranmain_master__map_all_launched.writeAction(f"sendr_wret X29 main_master::map_split_launcher_done X28 X17 X27") 
  ...
  tranmain_master__map_all_launched.writeAction(f"addi X26 X26 0")  # This is for casting. May be used later on
  tranmain_master__map_all_launched.writeAction(f"add X25 X26 X26") 
  ...
  tranmain_master__map_all_launched.writeAction(f"__while_map_all_launched_7_body: ev X24 X28 X25 X25 8") 
  tranmain_master__map_all_launched.writeAction(f"movir X29 0") 
  tranmain_master__map_all_launched.writeAction(f"evlb X29 main_master::send_to_global_master_thread") 
  tranmain_master__map_all_launched.writeAction(f"evi X29 X29 255 4") 
  tranmain_master__map_all_launched.writeAction(f"ev X29 X29 X25 X25 8") 
  tranmain_master__map_all_launched.writeAction(f"addi X23 X27 1") 
  tranmain_master__map_all_launched.writeAction(f"sendr3_wret X29 main_master::map_split_launcher_done X28 X17 X27 X30") 
  tranmain_master__map_all_launched.writeAction(f"addi X22 X28 0")  # This is for casting. May be used later on
  tranmain_master__map_all_launched.writeAction(f"add X25 X28 X25") 
  ...
  tranmain_master__map_split_launcher_done.writeAction(f"sendr_wret X26 main_master::reduce_launcher_done X23 X23 X25") 
  ...
  tranmain_master__map_split_launcher_done.writeAction(f"addi X25 X25 1") 
  tranmain_master__map_split_launcher_done.writeAction(f"movwlr X26(X25,0,0) X26") 
  tranmain_master__map_split_launcher_done.writeAction(f"movir X25 -1") 
  tranmain_master__map_split_launcher_done.writeAction(f"sri X25 X25 1") 
  tranmain_master__map_split_launcher_done.writeAction(f"sendr_wcont X26 X25 X20 X20") 
  ...
  tranmain_master__map_split_all_launched.writeAction(f"addi X19 X24 0")  # This is for casting. May be used later on
  tranmain_master__map_split_all_launched.writeAction(f"add X25 X24 X24") 
  tranmain_master__map_split_all_launched.writeAction(f"__while_map_split_all_launched_3_condition: ble X24 X25 __while_map_split_all_launched_5_post") 
  tranmain_master__map_split_all_launched.writeAction(f"__while_map_split_all_launched_4_body: ev X26 X28 X25 X25 8") 
  tranmain_master__map_split_all_launched.writeAction(f"movir X29 0") 
  tranmain_master__map_split_all_launched.writeAction(f"evlb X29 map_master__send_to_map_master_thread") 
  tranmain_master__map_split_all_launched.writeAction(f"evi X29 X29 255 4") 
  tranmain_master__map_split_all_launched.writeAction(f"ev X29 X29 X25 X25 8") 
  tranmain_master__map_split_all_launched.writeAction(f"sendr_wret X29 main_master::reduce_launcher_done X28 X25 X27") 
  ...
  tranmain_master__map_split_all_launched.writeAction(f"addi X0 X26 0") 
  tranmain_master__map_split_all_launched.writeAction(f"mul X19 X22 X24") 
  tranmain_master__map_split_all_launched.writeAction(f"addi X24 X24 0")  # This is for casting. May be used later on
  tranmain_master__map_split_all_launched.writeAction(f"add X26 X24 X24") 
  tranmain_master__map_split_all_launched.writeAction(f"__while_map_split_all_launched_6_condition: ble X24 X26 __if_map_split_all_launched_2_post") 
  tranmain_master__map_split_all_launched.writeAction(f"__while_map_split_all_launched_7_body: ev X25 X28 X26 X26 8") 
  tranmain_master__map_split_all_launched.writeAction(f"movir X29 0") 
  tranmain_master__map_split_all_launched.writeAction(f"evlb X29 main_master::send_to_global_master_thread") 
  tranmain_master__map_split_all_launched.writeAction(f"evi X29 X29 255 4") 
  tranmain_master__map_split_all_launched.writeAction(f"ev X29 X29 X26 X26 8") 
  tranmain_master__map_split_all_launched.writeAction(f"addi X23 X27 1") 
  tranmain_master__map_split_all_launched.writeAction(f"sendr3_wret X29 main_master::reduce_launcher_done X28 X17 X27 X30") 
  tranmain_master__map_split_all_launched.writeAction(f"addi X22 X28 0")  # This is for casting. May be used later on
  tranmain_master__map_split_all_launched.writeAction(f"add X26 X28 X26") 
  ...
  tranmain_master__reduce_launcher_done.writeAction(f"__if_reduce_launcher_done_3_true: sri X20 X26 1") 
  tranmain_master__reduce_launcher_done.writeAction(f"print '[Itera %lu]: add queue %lu traversed edges %lu' X17 X26 X21") 
  ...
  tranmain_master__reduce_launcher_done.writeAction(f"movir X26 1") 
  tranmain_master__reduce_launcher_done.writeAction(f"movrl X26 0(X24) 0 8") 
  ...
  tranmain_master__reduce_launcher_done.writeAction(f"send_wret X25 main_master::init_done X26 8 X28") 
  ...
  tranmain_master__reduce_launcher_done.writeAction(f"__if_reduce_launcher_done_4_false: sli X23 X26 1") 
  tranmain_master__reduce_launcher_done.writeAction(f"addi X26 X26 43") 
  tranmain_master__reduce_launcher_done.writeAction(f"addi X26 X26 1") 
  tranmain_master__reduce_launcher_done.writeAction(f"movwlr X24(X26,0,0) X26") 
  ...
  tranmain_master__reduce_launcher_done.writeAction(f"sendr_wcont X26 X25 X20 X21") 
  tranmain_master__reduce_launcher_done.writeAction(f"yield_terminate") 
