...
def EFA_launchers(efa):
  ...
  tranmap_master__send_to_map_master_thread.writeAction(f"addi X26 X26 0")  # This is for casting. May be used later on
  ## #ifdef DEBUG
  ...
  tranmap_master__vertex_term_split_v.writeAction(f"__entry: addi X7 X27 0") 
  ...
  tranmap_master__vertex_term_split_v.writeAction(f"movlr 208(X27) X26 0 8") 
  tranmap_master__vertex_term_split_v.writeAction(f"movlr 264(X27) X28 0 8") 
  tranmap_master__vertex_term_split_v.writeAction(f"add X26 X28 X26") 
  ## #ifdef DEBUG
  ...
  tranmap_master__vertex_term_split_v.writeAction(f"bneu X22 X26 __if_vertex_term_split_v_2_post") 
  tranmap_master__vertex_term_split_v.writeAction(f"__if_vertex_term_split_v_0_true: movlr 216(X27) X28 0 8") 
  tranmap_master__vertex_term_split_v.writeAction(f"bneiu X28 4 __if_vertex_term_split_v_2_post") 
  tranmap_master__vertex_term_split_v.writeAction(f"__if_vertex_term_split_v_3_true: movlr 168(X27) X28 0 8") 
  ...
  tranmap_master__vertex_term_split_v.writeAction(f"sendr_wcont X28 X29 X26 X0") 
  ## #ifdef DEBUG
  ...
  tranmap_master__vertex_term_split_v.writeAction(f"movrl X28 216(X27) 0 8") 
  tranmap_master__vertex_term_split_v.writeAction(f"__if_vertex_term_split_v_2_post: movlr 240(X27) X28 0 8") 
  tranmap_master__vertex_term_split_v.writeAction(f"movlr 248(X27) X26 0 8") 
  tranmap_master__vertex_term_split_v.writeAction(f"ble X26 X28 __if_vertex_term_split_v_8_post") 
  tranmap_master__vertex_term_split_v.writeAction(f"__if_vertex_term_split_v_6_true: send_dmlm_ld_wret X18 map_master::receive_dram_split_v 2 X26") 
  ...
  tranmap_master__vertex_term_split_v.writeAction(f"movrl X28 240(X27) 0 8") 
  ...
  tranmap_master__map_all_launched.writeAction(f"movlr 232(X28) X27 0 8") 
  tranmap_master__map_all_launched.writeAction(f"evi X2 X26 map_master::start_split_v 1") 
  tranmap_master__map_all_launched.writeAction(f"sendr_wret X26 map_master::vertex_term_split_v X27 X27 X29") 
  tranmap_master__map_all_launched.writeAction(f"movir X27 4") 
  tranmap_master__map_all_launched.writeAction(f"movrl X27 216(X28) 0 8") 
  ...
  tranmap_master__map_split_all_launched.writeAction(f"movlr 224(X28) X27 0 8") 
  tranmap_master__map_split_all_launched.writeAction(f"movir X26 6") 
  tranmap_master__map_split_all_launched.writeAction(f"movrl X26 216(X28) 0 8") 
  tranmap_master__map_split_all_launched.writeAction(f"addi X27 X26 1") 
  tranmap_master__map_split_all_launched.writeAction(f"bneu X24 X26 __if_map_split_all_launched_2_post") 
  tranmap_master__map_split_all_launched.writeAction(f"__if_map_split_all_launched_0_true: movlr 216(X28) X26 0 8") 
  tranmap_master__map_split_all_launched.writeAction(f"bneiu X26 6 __if_map_split_all_launched_2_post") 
  tranmap_master__map_split_all_launched.writeAction(f"__if_map_split_all_launched_3_true: movir X26 7") 
  tranmap_master__map_split_all_launched.writeAction(f"movrl X26 216(X28) 0 8") 
  tranmap_master__map_split_all_launched.writeAction(f"movlr 304(X28) X26 0 8") 
  tranmap_master__map_split_all_launched.writeAction(f"bleu X27 X26 __if_map_split_all_launched_8_post") 
  tranmap_master__map_split_all_launched.writeAction(f"__if_map_split_all_launched_6_true: movlr 304(X28) X26 0 8") 
  tranmap_master__map_split_all_launched.writeAction(f"print 'Reduce queue length %lu > malloc size %lu' X27 X26") 
  ## #ifdef DEBUG
  ...
  tranmap_master__map_split_all_launched.writeAction(f"__if_map_split_all_launched_8_post: movlr 232(X28) X26 0 8") 
  tranmap_master__map_split_all_launched.writeAction(f"andi X26 X26 1") 
  tranmap_master__map_split_all_launched.writeAction(f"bneiu X26 0 __if_map_split_all_launched_10_false") 
  tranmap_master__map_split_all_launched.writeAction(f"__if_map_split_all_launched_9_true: movlr 192(X28) X26 0 8") 
  tranmap_master__map_split_all_launched.writeAction(f"subi X26 X26 8") 
  tranmap_master__map_split_all_launched.writeAction(f"sendr_dmlm_wret X26 map_master::wrtie_reduce_length X27 X29") 
  ...
  tranmap_master__map_split_all_launched.writeAction(f"__if_map_split_all_launched_10_false: subi X19 X26 16") 
  tranmap_master__map_split_all_launched.writeAction(f"sendr_dmlm_wret X26 map_master::wrtie_reduce_length X27 X29") 
  tranmap_master__map_split_all_launched.writeAction(f"yield") 
  ...
  tranmap_master__wrtie_reduce_length.writeAction(f"movlr 168(X28) X27 0 8") 
  tranmap_master__wrtie_reduce_length.writeAction(f"movlr 224(X28) X28 0 8") 
  tranmap_master__wrtie_reduce_length.writeAction(f"movir X26 -1") 
  tranmap_master__wrtie_reduce_length.writeAction(f"sri X26 X26 1") 
  tranmap_master__wrtie_reduce_length.writeAction(f"sendr_wcont X27 X26 X28 X25") 
  ...
  tranmap_master__add_v.writeAction(f"addi X7 X27 0") 
  tranmap_master__add_v.writeAction(f"movir X28 0") 
  tranmap_master__add_v.writeAction(f"hash X8 X28") 
  tranmap_master__add_v.writeAction(f"movlr 320(X27) X26 0 8") 
  tranmap_master__add_v.writeAction(f"div X28 X26 X28") 
  tranmap_master__add_v.writeAction(f"andi X28 X28 2047") 
  tranmap_master__add_v.writeAction(f"addi X7 X27 16384") 
  tranmap_master__add_v.writeAction(f"sli X28 X29 1") 
  tranmap_master__add_v.writeAction(f"movwlr X27(X29,0,0) X26") 
  tranmap_master__add_v.writeAction(f"movir X28 -1") 
  tranmap_master__add_v.writeAction(f"bne X8 X26 __if_add_v_2_post") 
  ...
  tranmap_master__add_v.writeAction(f"__if_add_v_2_post: bne X26 X28 __if_add_v_5_post") 
  tranmap_master__add_v.writeAction(f"__if_add_v_3_true: movwrl X8 X27(X29,0,0)") 
  tranmap_master__add_v.writeAction(f"addi X29 X26 1") 
  tranmap_master__add_v.writeAction(f"movwrl X28 X27(X26,0,0)") 
  tranmap_master__add_v.writeAction(f"__if_add_v_5_post: addi X7 X27 0") 
  tranmap_master__add_v.writeAction(f"movlr 224(X27) X28 0 8") 
  tranmap_master__add_v.writeAction(f"sli X28 X29 3") 
  tranmap_master__add_v.writeAction(f"add X19 X29 X29") 
  tranmap_master__add_v.writeAction(f"sendr2_dmlm_wret X29 map_master::wrtie_reduce_queue_return X8 X9 X26") 
  tranmap_master__add_v.writeAction(f"addi X28 X28 2") 
  tranmap_master__add_v.writeAction(f"movrl X28 224(X27) 0 8") 
  tranmap_master__add_v.writeAction(f"movir X27 -1") 
  tranmap_master__add_v.writeAction(f"sri X27 X27 1") 
  tranmap_master__add_v.writeAction(f"sendr_wcont X1 X27 X8 X8") 
  tranmap_master__add_v.writeAction(f"yield") 
  
  # Writing code for event map_master::add_vertex
  tranmap_master__add_vertex = efa.writeEvent('map_master::add_vertex')
  tranmap_master__add_vertex.writeAction(f"__entry: addi X7 X27 0") 
  tranmap_master__add_vertex.writeAction(f"movlr 160(X27) X27 0 8") 
  tranmap_master__add_vertex.writeAction(f"addi X27 X27 0")  # This is for casting. May be used later on
  tranmap_master__add_vertex.writeAction(f"evi X2 X28 map_master::add_v 1") 
  tranmap_master__add_vertex.writeAction(f"ev X28 X27 X27 X27 4") 
  tranmap_master__add_vertex.writeAction(f"sendr_wcont X27 X1 X8 X9") 
  ...
  tranmap_master__add_split_vertex.writeAction(f"__entry: addi X7 X27 0") 
  tranmap_master__add_split_vertex.writeAction(f"movlr 160(X27) X27 0 8") 
  tranmap_master__add_split_vertex.writeAction(f"addi X27 X27 0")  # This is for casting. May be used later on
  tranmap_master__add_split_vertex.writeAction(f"evi X2 X28 map_master::add_split_v 1") 
  tranmap_master__add_split_vertex.writeAction(f"ev X28 X27 X27 X27 4") 
  tranmap_master__add_split_vertex.writeAction(f"sendr_wcont X27 X1 X8 X9") 
  ...
  tranmap_master__add_split_v.writeAction(f"__entry: movir X27 -1") 
  tranmap_master__add_split_v.writeAction(f"sri X27 X27 1") 
  tranmap_master__add_split_v.writeAction(f"sendr_wcont X1 X27 X8 X8") 
  ...
  tranmap_master__add_split_v.writeAction(f"addi X7 X27 0") 
  tranmap_master__add_split_v.writeAction(f"movir X28 0") 
  tranmap_master__add_split_v.writeAction(f"hash X8 X28") 
  tranmap_master__add_split_v.writeAction(f"movlr 320(X27) X29 0 8") 
  ...
  tranmap_master__add_split_v.writeAction(f"addi X7 X27 16384") 
  tranmap_master__add_split_v.writeAction(f"movwlr X27(X28,0,0) X26") 
  tranmap_master__add_split_v.writeAction(f"movir X29 -1") 
  tranmap_master__add_split_v.writeAction(f"bne X8 X26 __if_add_split_v_2_post") 
  tranmap_master__add_split_v.writeAction(f"__if_add_split_v_0_true: addi X28 X30 1") 
  tranmap_master__add_split_v.writeAction(f"movwlr X27(X30,0,0) X30") 
  ...
  tranmap_master__add_split_v.writeAction(f"__if_add_split_v_2_post: bneu X26 X29 __if_add_split_v_8_post") 
  tranmap_master__add_split_v.writeAction(f"__if_add_split_v_6_true: movwrl X8 X27(X28,0,0)") 
  tranmap_master__add_split_v.writeAction(f"subi X29 X29 1") 
  tranmap_master__add_split_v.writeAction(f"addi X28 X30 1") 
  tranmap_master__add_split_v.writeAction(f"movwrl X29 X27(X30,0,0)") 
  tranmap_master__add_split_v.writeAction(f"__if_add_split_v_8_post: addi X7 X27 0") 
  ...
  tranmap_master__add_split_v.writeAction(f"movlr 192(X27) X28 0 8") 
  tranmap_master__add_split_v.writeAction(f"movlr 208(X27) X26 0 8") 
  tranmap_master__add_split_v.writeAction(f"sli X26 X29 3") 
  tranmap_master__add_split_v.writeAction(f"add X28 X29 X28") 
  tranmap_master__add_split_v.writeAction(f"addi X26 X26 2") 
  tranmap_master__add_split_v.writeAction(f"movrl X26 208(X27) 0 8") 
  tranmap_master__add_split_v.writeAction(f"movlr 304(X27) X29 0 8") 
  tranmap_master__add_split_v.writeAction(f"bleu X26 X29 __if_add_split_v_11_post") 
  tranmap_master__add_split_v.writeAction(f"__if_add_split_v_9_true: movlr 304(X27) X29 0 8") 
  tranmap_master__add_split_v.writeAction(f"print 'Error, queue length not long enough, please increase queue length, current queue length is %lu, need queue length is %lu' X29 X26") 
  tranmap_master__add_split_v.writeAction(f"__if_add_split_v_11_post: sendr2_dmlm_wret X28 map_master::write_map_queue_return X8 X9 X26") 
  ...
  tranmap_master__write_map_queue_return.writeAction(f"movlr 256(X28) X26 0 8") 
  tranmap_master__write_map_queue_return.writeAction(f"addi X26 X26 2") 
  tranmap_master__write_map_queue_return.writeAction(f"movrl X26 256(X28) 0 8") 
  tranmap_master__write_map_queue_return.writeAction(f"movlr 208(X28) X27 0 8") 
  tranmap_master__write_map_queue_return.writeAction(f"bneu X26 X27 __if_write_map_queue_return_2_post") 
  tranmap_master__write_map_queue_return.writeAction(f"__if_write_map_queue_return_0_true: movrl X26 248(X28) 0 8") 
  tranmap_master__write_map_queue_return.writeAction(f"bleiu X17 0 __if_write_map_queue_return_2_post") 
  tranmap_master__write_map_queue_return.writeAction(f"__if_write_map_queue_return_3_true: movlr 240(X28) X27 0 8") 
  tranmap_master__write_map_queue_return.writeAction(f"__while_write_map_queue_return_6_condition: cgti X17 X29 0") 
  tranmap_master__write_map_queue_return.writeAction(f"clt X27 X26 X30") 
  ...
  tranmap_master__write_map_queue_return.writeAction(f"__while_write_map_queue_return_8_post: movrl X27 240(X28) 0 8") 
  ...
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"__entry: addi X7 X26 0") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"addi X24 X24 2") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"movlr 224(X26) X28 0 8") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"addi X28 X27 1") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"bneu X24 X27 __if_wrtie_reduce_queue_return_2_post") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"__if_wrtie_reduce_queue_return_0_true: movlr 216(X26) X27 0 8") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"bneiu X27 6 __if_wrtie_reduce_queue_return_2_post") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"__if_wrtie_reduce_queue_return_3_true: movir X27 7") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"movrl X27 216(X26) 0 8") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"movlr 304(X26) X27 0 8") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"bleu X28 X27 __if_wrtie_reduce_queue_return_8_post") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"__if_wrtie_reduce_queue_return_6_true: movlr 304(X26) X27 0 8") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"print 'Reduce queue length %lu > malloc size %lu' X28 X27") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"__if_wrtie_reduce_queue_return_8_post: movlr 232(X26) X27 0 8") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"andi X27 X27 1") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"bneiu X27 0 __if_wrtie_reduce_queue_return_10_false") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"__if_wrtie_reduce_queue_return_9_true: movlr 192(X26) X27 0 8") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"subi X27 X27 8") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"sendr_dmlm_wret X27 map_master::wrtie_reduce_length X28 X29") 
  ...
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"__if_wrtie_reduce_queue_return_10_false: subi X19 X27 16") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"sendr_dmlm_wret X27 map_master::wrtie_reduce_length X28 X29") 
  tranmap_master__wrtie_reduce_queue_return.writeAction(f"yield") 
