...
def EFA_splitPagerankMSR(efa):
  ...
  ## Param "push_value_op" uses Register X15, scope (0->4)
  ...
  ## Scoped Variable "tmp_lm_ptr" uses Register X27, scope (0->4->10)
  ## Scoped Variable "evw" uses Register X26, scope (0->4->15)
  ## Scoped Variable "deg" uses Register X26, scope (0->4->15->18)
  ## Param "vid_sibling" uses Register X8, scope (0->21)
  ## Param "deg_sibling" uses Register X9, scope (0->21)
  ## Param "neighbors_sibling" uses Register X10, scope (0->21)
  ## Param "orig_vid" uses Register X11, scope (0->21)
  ## Param "split_start_sibling" uses Register X12, scope (0->21)
  ## Param "split_bound_sibling" uses Register X13, scope (0->21)
  ## Param "val_sibling" uses Register X14, scope (0->21)
  ## Param "push_value_sibling" uses Register X15, scope (0->21)
  ## Param "vertex_addr" uses Register X3, scope (0->21)
  ## Scoped Variable "num_siblings" uses Register X26, scope (0->21)
  ## Scoped Variable "evw" uses Register X27, scope (0->21->27)
  ## Param "vid_op" uses Register X8, scope (0->29)
  ## Param "out_value_op" uses Register X9, scope (0->29)
  ## Scoped Variable "evw" uses Register X26, scope (0->29)
  ## Param "e0" uses Register X8, scope (0->33)
  ## Param "e1" uses Register X9, scope (0->33)
  ## Param "e2" uses Register X10, scope (0->33)
  ## Param "e3" uses Register X11, scope (0->33)
  ## Param "e4" uses Register X12, scope (0->33)
  ## Param "e5" uses Register X13, scope (0->33)
  ## Param "e6" uses Register X14, scope (0->33)
  ## Param "e7" uses Register X15, scope (0->33)
  ## Param "curr_nlist_addr" uses Register X3, scope (0->33)
  ## Scoped Variable "tmp_nlist_ptr" uses Register X26, scope (0->33)
  ## Scoped Variable "evw" uses Register X27, scope (0->33->36)
  ## Scoped Variable "evw" uses Register X27, scope (0->33->42)
  ## Scoped Variable "evw" uses Register X27, scope (0->33->48)
  ## Scoped Variable "evw" uses Register X27, scope (0->33->54)
  ## Scoped Variable "evw" uses Register X27, scope (0->33->60)
  ## Scoped Variable "evw" uses Register X27, scope (0->33->66)
  ## Scoped Variable "evw" uses Register X27, scope (0->33->72)
  ## Scoped Variable "evw" uses Register X27, scope (0->33->78)
  ## Scoped Variable "tmp_lm_ptr" uses Register X16, scope (0)
  ## Param "partition_array" uses Register X8, scope (0->82)
  ## Param "NUM_PARTITION_PER_LANE" uses Register X9, scope (0->82)
  ## Param "num_lanes" uses Register X10, scope (0->82)
  ## Param "vertices" uses Register X11, scope (0->82)
  ## Param "num_vertices" uses Register X12, scope (0->82)
  ## Param "values" uses Register X13, scope (0->82)
  ## Param "num_values" uses Register X14, scope (0->82)
  ## Scoped Variable "send_buffer" uses Register X17, scope (0->82)
  ## Scoped Variable "evw" uses Register X18, scope (0->82)
  ...
  transplitPageRankMS__kv_map.writeAction(f"entry: ceq X8 X11 X26") 
  transplitPageRankMS__kv_map.writeAction(f"ceqi X9 X27 0") 
  transplitPageRankMS__kv_map.writeAction(f"and X26 X27 X28") 
  transplitPageRankMS__kv_map.writeAction(f"beqi X28 0 __if_kv_map_2_post") 
  transplitPageRankMS__kv_map.writeAction(f"__if_kv_map_0_true: evi X2 X26 transplitPageRankMS::kv_map_return 1") 
  transplitPageRankMS__kv_map.writeAction(f"sendr_wcont X26 X2 X8 X8") 
  transplitPageRankMS__kv_map.writeAction(f"yield") 
  transplitPageRankMS__kv_map.writeAction(f"__if_kv_map_2_post: addi X8 X16 0") 
  transplitPageRankMS__kv_map.writeAction(f"addi X9 X17 0") 
  ...
  transplitPageRankMS__kv_map.writeAction(f"sli X9 X26 3") 
  transplitPageRankMS__kv_map.writeAction(f"add X10 X26 X20") 
  transplitPageRankMS__kv_map.writeAction(f"addi X10 X18 0") 
  transplitPageRankMS__kv_map.writeAction(f"ceq X8 X11 X26") 
  transplitPageRankMS__kv_map.writeAction(f"xori X26 X26 1") 
  transplitPageRankMS__kv_map.writeAction(f"ceqi X15 X27 0") 
  transplitPageRankMS__kv_map.writeAction(f"and X26 X27 X28") 
  transplitPageRankMS__kv_map.writeAction(f"beqi X28 0 __if_kv_map_10_false") 
  ...
  transplitPageRankMS__kv_map.writeAction(f"addi X7 X27 768") 
  transplitPageRankMS__kv_map.writeAction(f"movlr 0(X27) X21 0 8") 
  transplitPageRankMS__kv_map.writeAction(f"sli X22 X28 6") 
  transplitPageRankMS__kv_map.writeAction(f"add X21 X28 X21") 
  ## Issue DRAM read requests to fetch sibling vertices
  transplitPageRankMS__kv_map.writeAction(f"movir X24 0") 
  transplitPageRankMS__kv_map.writeAction(f"__while_kv_map_15_condition: clt X22 X13 X28") 
  transplitPageRankMS__kv_map.writeAction(f"clt X24 X26 X29") 
  transplitPageRankMS__kv_map.writeAction(f"and X28 X29 X30") 
  transplitPageRankMS__kv_map.writeAction(f"beqi X30 0 __while_kv_map_17_post") 
  ...
  transplitPageRankMS__kv_map.writeAction(f"__while_kv_map_17_post: movir X19 0") 
  ...
  transplitPageRankMS__kv_map.writeAction(f"__if_kv_map_10_false: beqi X15 0 __if_kv_map_22_false") 
  transplitPageRankMS__kv_map.writeAction(f"__if_kv_map_21_true: print 'This code should not trigger...'") 
  ## if (DEBUG_FLAG) {
  ##     print("[DEBUG][NWID %d][kv_map] Vertex %ld is split but a sibling has computed the push value %lu, skip merge...", NETID, vid_op, push_value_op);
  ## }
  ## out_value = push_value_op;
  transplitPageRankMS__kv_map.writeAction(f"jmp __if_kv_map_23_post") 
  transplitPageRankMS__kv_map.writeAction(f"__if_kv_map_22_false: fcnvt.i64.64 X9 X26")  # This is for casting. May be used later on
  transplitPageRankMS__kv_map.writeAction(f"fdiv.64 X14 X26 X19") 
  transplitPageRankMS__kv_map.writeAction(f"__if_kv_map_23_post: evi X2 X26 splitPageRankMS::push_update 1") 
  ...
  transplitPageRankMS__sibling_rd_return.writeAction(f"fcnvt.i64.64 X9 X26")  # This is for casting. May be used later on
  ...
  transplitPageRankMS__sibling_rd_return.writeAction(f"__if_sibling_rd_return_9_true: fdiv.64 X19 X23 X19") 
  transplitPageRankMS__sibling_rd_return.writeAction(f"evi X2 X27 splitPageRankMS::push_update 1") 
  transplitPageRankMS__sibling_rd_return.writeAction(f"sendr_wcont X27 X2 X16 X19") 
  ...
  transplitPageRankMS__push_update.writeAction(f"evlb X25 transplitPageRankMS::kv_map_emit") 
  ...
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_3_true: evi X2 X27 transplitPageRankMS::kv_map_return 1") 
  ...
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_5_post: bgt X20 X26 __if_rd_nlist_return_11_post") 
  ...
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_15_true: evi X2 X27 transplitPageRankMS::kv_map_return 1") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"sendr_wcont X27 X2 X16 X16") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"yield") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_17_post: bgt X20 X26 __if_rd_nlist_return_23_post") 
  ...
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_27_true: evi X2 X27 transplitPageRankMS::kv_map_return 1") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"sendr_wcont X27 X2 X16 X16") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"yield") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_29_post: bgt X20 X26 __if_rd_nlist_return_35_post") 
  ...
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_39_true: evi X2 X27 transplitPageRankMS::kv_map_return 1") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"sendr_wcont X27 X2 X16 X16") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"yield") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_41_post: bgt X20 X26 __if_rd_nlist_return_47_post") 
  ...
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_51_true: evi X2 X27 transplitPageRankMS::kv_map_return 1") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"sendr_wcont X27 X2 X16 X16") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"yield") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_53_post: bgt X20 X26 __if_rd_nlist_return_59_post") 
  ...
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_63_true: evi X2 X27 transplitPageRankMS::kv_map_return 1") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"sendr_wcont X27 X2 X16 X16") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"yield") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_65_post: bgt X20 X26 __if_rd_nlist_return_71_post") 
  ...
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_75_true: evi X2 X27 transplitPageRankMS::kv_map_return 1") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"sendr_wcont X27 X2 X16 X16") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"yield") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_77_post: bgt X20 X26 __if_rd_nlist_return_83_post") 
  ...
  transplitPageRankMS__rd_nlist_return.writeAction(f"__if_rd_nlist_return_87_true: evi X2 X27 transplitPageRankMS::kv_map_return 1") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"sendr_wcont X27 X2 X16 X16") 
  transplitPageRankMS__rd_nlist_return.writeAction(f"yield") 
  ...
  tranInitUpDown__init.writeAction(f"evlb X18 transplitPageRankMS::map_shuffle_reduce") 
