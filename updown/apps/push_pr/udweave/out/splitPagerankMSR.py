...
def EFA_splitPagerankMSR(efa):
  ...
  ## Scoped Variable "max_parallelism" uses Register X26, scope (0->4->9)
  ## Scoped Variable "deg" uses Register X26, scope (0->4->14)
  ## Scoped Variable "evw" uses Register X27, scope (0->4->14)
  ## Param "deg_sibling" uses Register X8, scope (0->17)
  ## Param "vid_sibling" uses Register X9, scope (0->17)
  ## Param "neighbors_sibling" uses Register X10, scope (0->17)
  ## Param "orig_vid" uses Register X11, scope (0->17)
  ## Param "split_start_sibling" uses Register X12, scope (0->17)
  ## Param "split_bound_sibling" uses Register X13, scope (0->17)
  ## Param "val_sibling" uses Register X14, scope (0->17)
  ## Param "gv_bin" uses Register X15, scope (0->17)
  ## Param "vertex_addr" uses Register X3, scope (0->17)
  ## Scoped Variable "num_siblings" uses Register X26, scope (0->17)
  ## Scoped Variable "deg" uses Register X27, scope (0->17->23)
  ## Scoped Variable "evw" uses Register X28, scope (0->17->23)
  ## Param "vid_op" uses Register X8, scope (0->25)
  ## Param "out_value_op" uses Register X9, scope (0->25)
  ## Scoped Variable "evw" uses Register X26, scope (0->25)
  ## Param "e0" uses Register X8, scope (0->29)
  ## Param "e1" uses Register X9, scope (0->29)
  ## Param "e2" uses Register X10, scope (0->29)
  ## Param "e3" uses Register X11, scope (0->29)
  ## Param "e4" uses Register X12, scope (0->29)
  ## Param "e5" uses Register X13, scope (0->29)
  ## Param "e6" uses Register X14, scope (0->29)
  ## Param "e7" uses Register X15, scope (0->29)
  ## Param "curr_nlist_addr" uses Register X3, scope (0->29)
  ## Scoped Variable "tmp_nlist_ptr" uses Register X26, scope (0->29)
  ## Scoped Variable "evw" uses Register X27, scope (0->29->32)
  ## Scoped Variable "evw" uses Register X27, scope (0->29->38)
  ## Scoped Variable "evw" uses Register X27, scope (0->29->44)
  ## Scoped Variable "evw" uses Register X27, scope (0->29->50)
  ## Scoped Variable "evw" uses Register X27, scope (0->29->56)
  ## Scoped Variable "evw" uses Register X27, scope (0->29->62)
  ## Scoped Variable "evw" uses Register X27, scope (0->29->68)
  ## Scoped Variable "evw" uses Register X27, scope (0->29->74)
  ## Scoped Variable "tmp_lm_ptr" uses Register X16, scope (0)
  ## Param "partition_array" uses Register X8, scope (0->78)
  ## Param "NUM_PARTITION_PER_LANE" uses Register X9, scope (0->78)
  ## Param "num_lanes" uses Register X10, scope (0->78)
  ## Param "vertices" uses Register X11, scope (0->78)
  ## Param "num_vertices" uses Register X12, scope (0->78)
  ## Param "values" uses Register X13, scope (0->78)
  ## Param "num_values" uses Register X14, scope (0->78)
  ## Scoped Variable "send_buffer" uses Register X17, scope (0->78)
  ## Scoped Variable "evw" uses Register X18, scope (0->78)
  ...
  transplitPageRankMS__kv_map.writeAction(f"beq X9 X11 __if_kv_map_7_false") 
  ## if (deg_op == 0) {
  ## If the vertex is split, we need to pull the values from the sibling vertices
  transplitPageRankMS__kv_map.writeAction(f"__if_kv_map_6_true: evi X2 X25 splitPageRankMS::sibling_rd_return 1") 
  ...
  transplitPageRankMS__kv_map.writeAction(f"__while_kv_map_12_condition: clt X22 X13 X27") 
  transplitPageRankMS__kv_map.writeAction(f"clt X24 X26 X28") 
  transplitPageRankMS__kv_map.writeAction(f"and X27 X28 X29") 
  transplitPageRankMS__kv_map.writeAction(f"beqi X29 0 __while_kv_map_14_post") 
  transplitPageRankMS__kv_map.writeAction(f"__while_kv_map_13_body: send_dmlm_ld X21 X25 8") 
  ...
  transplitPageRankMS__kv_map.writeAction(f"jmp __while_kv_map_12_condition") 
  transplitPageRankMS__kv_map.writeAction(f"__while_kv_map_14_post: movir X24 0") 
  ...
  transplitPageRankMS__kv_map.writeAction(f"yield") 
  transplitPageRankMS__kv_map.writeAction(f"jmp __if_kv_map_8_post") 
  ## If the vertex is not split, we can process it directly
  transplitPageRankMS__kv_map.writeAction(f"__if_kv_map_7_false: fcnvt.i64.64 X8 X26")  # This is for casting. May be used later on
  ...
  transplitPageRankMS__kv_map.writeAction(f"yield") 
  transplitPageRankMS__kv_map.writeAction(f"__if_kv_map_8_post: yield") 
