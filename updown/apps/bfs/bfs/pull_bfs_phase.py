...
def EFA_BfsPullPhase(efa):
  ...
  ## Param "deg_op" uses Register X8, scope (0->3)
  ## Param "orig_vid_op" uses Register X9, scope (0->3)
  ## Param "vid_op" uses Register X10, scope (0->3)
  ## Param "neighbors_op" uses Register X11, scope (0->3)
  ## Param "dist_op" uses Register X12, scope (0->3)
  ## Param "parent_op" uses Register X13, scope (0->3)
  ## Param "split_range_op" uses Register X14, scope (0->3)
  ## Param "padding_op" uses Register X15, scope (0->3)
  ## Param "vertex_addr" uses Register X3, scope (0->3)
  ## Scoped Variable "tmp_lm_ptr" uses Register X26, scope (0->3)
  ## Scoped Variable "evw" uses Register X27, scope (0->3)
  ## Scoped Variable "max_fetch_size" uses Register X28, scope (0->3)
  ## Scoped Variable "evw" uses Register X27, scope (0->3->6)
  ## Scoped Variable "evw" uses Register X27, scope (0->3->9)
  ## Param "e0" uses Register X8, scope (0->15)
  ## Param "e1" uses Register X9, scope (0->15)
  ## Param "e2" uses Register X10, scope (0->15)
  ## Param "e3" uses Register X11, scope (0->15)
  ## Param "e4" uses Register X12, scope (0->15)
  ## Param "e5" uses Register X13, scope (0->15)
  ## Param "e6" uses Register X14, scope (0->15)
  ## Param "e7" uses Register X15, scope (0->15)
  ## Param "curr_nlist_addr" uses Register X3, scope (0->15)
  ## Scoped Variable "tmp_nlist_ptr" uses Register X26, scope (0->15)
  ## Scoped Variable "read_vertex_evw" uses Register X27, scope (0->15)
  ## Scoped Variable "tmp_vertex_addr" uses Register X28, scope (0->15)
  ## Scoped Variable "tmp_lm_ptr" uses Register X26, scope (0->15->17->20)
  ## Scoped Variable "orig_graph" uses Register X27, scope (0->15->17->20)
  ## Scoped Variable "orig_vertex_addr" uses Register X28, scope (0->15->17->20)
  ## Scoped Variable "cont" uses Register X29, scope (0->15->17->20)
  ## Param "deg_op" uses Register X8, scope (0->40)
  ## Param "orig_vid_op" uses Register X9, scope (0->40)
  ## Param "vid_op" uses Register X10, scope (0->40)
  ## Param "neighbors_op" uses Register X11, scope (0->40)
  ## Param "dist_op" uses Register X12, scope (0->40)
  ## Param "parent_op" uses Register X13, scope (0->40)
  ## Param "split_range_op" uses Register X14, scope (0->40)
  ## Param "padding_op" uses Register X15, scope (0->40)
  ## Param "vertex_addr" uses Register X3, scope (0->40)
  ## Scoped Variable "tmp_lm_ptr" uses Register X26, scope (0->40->45->47)
  ## Scoped Variable "orig_graph" uses Register X27, scope (0->40->45->47)
  ## Scoped Variable "orig_vertex_addr" uses Register X28, scope (0->40->45->47)
  ## Scoped Variable "cont" uses Register X29, scope (0->40->45->47)
  ## Scoped Variable "evw" uses Register X26, scope (0->40->45->49)
  ## Scoped Variable "tmp_lm_ptr" uses Register X27, scope (0->40->45->49)
  ## Param "deg_op" uses Register X8, scope (0->51)
  ## Param "orig_vid_op" uses Register X9, scope (0->51)
  ## Param "vid_op" uses Register X10, scope (0->51)
  ## Param "neighbors_op" uses Register X11, scope (0->51)
  ## Param "dist_op" uses Register X12, scope (0->51)
  ## Param "parent_op" uses Register X13, scope (0->51)
  ## Param "split_range_op" uses Register X14, scope (0->51)
  ## Param "padding_op" uses Register X15, scope (0->51)
  ## Param "vertex_addr" uses Register X3, scope (0->51)
  ## Scoped Variable "tmp_vertex_addr" uses Register X26, scope (0->51)
  ## Scoped Variable "cont" uses Register X27, scope (0->51)
  ## Scoped Variable "sibling_bound" uses Register X28, scope (0->51)
  ## Scoped Variable "evw" uses Register X26, scope (0->51->53)
  ## Scoped Variable "tmp_lm_ptr" uses Register X27, scope (0->51->53)
  ## Scoped Variable "cont" uses Register X26, scope (0->51->58)
  ## Scoped Variable "tmp_lm_ptr" uses Register X27, scope (0->51->58)
  ## Scoped Variable "frontier_evw" uses Register X28, scope (0->51->58)
  ## Scoped Variable "tmp_lm_ptr" uses Register X26, scope (0->51->61)
  ## Scoped Variable "sibling_bound" uses Register X27, scope (0->51->61)
  ## Scoped Variable "evw" uses Register X28, scope (0->51->61)
  ## Param "sibling_bound" uses Register X8, scope (0->63)
  ## Scoped Variable "tmp_vertex_addr" uses Register X26, scope (0->63)
  ## Scoped Variable "evw" uses Register X27, scope (0->63)
  ## Scoped Variable "max_batch_vid" uses Register X28, scope (0->63)
  ## Param "frontier_addr" uses Register X8, scope (0->70)
  ## Scoped Variable "sibling_bound" uses Register X26, scope (0->70)
  ## Scoped Variable "evw" uses Register X27, scope (0->70)
  ## Param "frontier_addr" uses Register X8, scope (0->72)
  ## Param "sibling_bound" uses Register X9, scope (0->72)
  ## Scoped Variable "tmp_vertex_addr" uses Register X26, scope (0->72)
  ## Scoped Variable "frontier_ptr" uses Register X27, scope (0->72)
  ## Scoped Variable "evw" uses Register X28, scope (0->72)
  ## Scoped Variable "max_batch_vid" uses Register X29, scope (0->72)
  ## Param "return_addr" uses Register X8, scope (0->79)
  ## Scoped Variable "evw" uses Register X26, scope (0->79->82)
  ...
  tranBFS_pull__kv_map.writeAction(f"beqi X29 0 __if_kv_map_5_post") 
  tranBFS_pull__kv_map.writeAction(f"__if_kv_map_3_true: evi X2 X27 BFS_pull::kv_map_return 1") 
  tranBFS_pull__kv_map.writeAction(f"addi X7 X26 112") 
  tranBFS_pull__kv_map.writeAction(f"movlr 0(X26) X29 0 8") 
  tranBFS_pull__kv_map.writeAction(f"addi X29 X30 0") 
  tranBFS_pull__kv_map.writeAction(f"movrl X30 0(X26) 0 8") 
  ...
  tranBFS_pull__kv_map.writeAction(f"__while_kv_map_17_post: movir X22 -1") 
  tranBFS_pull__kv_map.writeAction(f"yield") 
  
  # Writing code for event BFS_pull::rd_nlist_return
  tranBFS_pull__rd_nlist_return = efa.writeEvent('BFS_pull::rd_nlist_return')
  tranBFS_pull__rd_nlist_return.writeAction(f"entry: blti X22 0 __if_rd_nlist_return_2_post") 
  ...
  tranBFS_pull__rd_nlist_return.writeAction(f"movlr 0(X26) X27 0 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"sli X21 X29 6") 
  tranBFS_pull__rd_nlist_return.writeAction(f"add X27 X29 X28") 
  tranBFS_pull__rd_nlist_return.writeAction(f"evi X2 X29 BFS_pull::read_orig_vertex 1") 
  tranBFS_pull__rd_nlist_return.writeAction(f"send_dmlm_ld X28 X29 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"__if_rd_nlist_return_8_post: yield") 
  tranBFS_pull__rd_nlist_return.writeAction(f"__if_rd_nlist_return_2_post: ble X23 X17 __if_rd_nlist_return_14_post") 
  ...
  tranBFS_pull__rd_nlist_return.writeAction(f"bgt X23 X26 __if_rd_nlist_return_17_post") 
  ...
  tranBFS_pull__rd_nlist_return.writeAction(f"bgt X23 X26 __if_rd_nlist_return_20_post") 
  ...
  tranBFS_pull__rd_nlist_return.writeAction(f"send_dmlm_ld X28 X27 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"addi X26 X26 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"bgt X23 X26 __if_rd_nlist_return_23_post") 
  ...
  tranBFS_pull__rd_nlist_return.writeAction(f"send_dmlm_ld X28 X27 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"addi X26 X26 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"bgt X23 X26 __if_rd_nlist_return_26_post") 
  ...
  tranBFS_pull__rd_nlist_return.writeAction(f"send_dmlm_ld X28 X27 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"addi X26 X26 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"bgt X23 X26 __if_rd_nlist_return_29_post") 
  ...
  tranBFS_pull__rd_nlist_return.writeAction(f"send_dmlm_ld X28 X27 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"addi X26 X26 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"bgt X23 X26 __if_rd_nlist_return_32_post") 
  ...
  tranBFS_pull__rd_nlist_return.writeAction(f"send_dmlm_ld X28 X27 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"addi X26 X26 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"bgt X23 X26 __if_rd_nlist_return_35_post") 
  ...
  tranBFS_pull__rd_nlist_return.writeAction(f"send_dmlm_ld X28 X27 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"addi X26 X26 8") 
  tranBFS_pull__rd_nlist_return.writeAction(f"bgt X23 X26 __if_rd_nlist_return_38_post") 
  ...
  tranBFS_pull__read_vertex.writeAction(f"entry: subi X24 X24 1") 
  tranBFS_pull__read_vertex.writeAction(f"clti X22 X26 0") 
  tranBFS_pull__read_vertex.writeAction(f"subi X25 X27 1") 
  tranBFS_pull__read_vertex.writeAction(f"ceq X12 X27 X28") 
  tranBFS_pull__read_vertex.writeAction(f"and X26 X28 X29") 
  tranBFS_pull__read_vertex.writeAction(f"beqi X29 0 __if_read_vertex_5_post") 
  ...
  tranBFS_pull__read_vertex.writeAction(f"movlr 0(X26) X27 0 8") 
  tranBFS_pull__read_vertex.writeAction(f"sli X21 X29 6") 
  tranBFS_pull__read_vertex.writeAction(f"add X27 X29 X28") 
  tranBFS_pull__read_vertex.writeAction(f"evi X2 X29 BFS_pull::read_orig_vertex 1") 
  tranBFS_pull__read_vertex.writeAction(f"send_dmlm_ld X28 X29 8") 
  ...
  tranBFS_pull__read_vertex.writeAction(f"addi X7 X27 112") 
  tranBFS_pull__read_vertex.writeAction(f"movlr 0(X27) X29 0 8") 
  tranBFS_pull__read_vertex.writeAction(f"addi X29 X30 0") 
  tranBFS_pull__read_vertex.writeAction(f"movrl X30 0(X27) 0 8") 
  ...
  tranBFS_pull__read_orig_vertex.writeAction(f"entry: bne X12 X25 __if_read_orig_vertex_2_post") 
  tranBFS_pull__read_orig_vertex.writeAction(f"__if_read_orig_vertex_0_true: evi X2 X26 BFS_pull::kv_map_return 1") 
  tranBFS_pull__read_orig_vertex.writeAction(f"addi X7 X27 112") 
  tranBFS_pull__read_orig_vertex.writeAction(f"movlr 0(X27) X29 0 8") 
  tranBFS_pull__read_orig_vertex.writeAction(f"addi X29 X30 0") 
  tranBFS_pull__read_orig_vertex.writeAction(f"movrl X30 0(X27) 0 8") 
  ...
  tranBFS_pull__read_orig_vertex.writeAction(f"evlb X28 BFS::allocate_frontier") 
  ...
  tranBFS_pull__read_orig_vertex.writeAction(f"addi X7 X27 112") 
  tranBFS_pull__read_orig_vertex.writeAction(f"movlr 0(X27) X30 0 8") 
  tranBFS_pull__read_orig_vertex.writeAction(f"add X30 X19 X31") 
  tranBFS_pull__read_orig_vertex.writeAction(f"movrl X31 0(X27) 0 8") 
  tranBFS_pull__read_orig_vertex.writeAction(f"jmp __if_read_orig_vertex_14_post") 
  tranBFS_pull__read_orig_vertex.writeAction(f"__if_read_orig_vertex_13_false: addi X7 X26 112") 
  tranBFS_pull__read_orig_vertex.writeAction(f"movlr 0(X26) X28 0 8") 
  tranBFS_pull__read_orig_vertex.writeAction(f"add X28 X19 X29") 
  tranBFS_pull__read_orig_vertex.writeAction(f"movrl X29 0(X26) 0 8") 
  tranBFS_pull__read_orig_vertex.writeAction(f"add X18 X19 X27") 
  tranBFS_pull__read_orig_vertex.writeAction(f"evi X2 X28 BFS_pull::update_siblings 1") 
  tranBFS_pull__read_orig_vertex.writeAction(f"sendr_wcont X28 X1 X27 X27") 
  ...
  tranBFS_pull__read_orig_vertex.writeAction(f"evi X2 X27 BFS_pull::write_dram_return 1") 
  tranBFS_pull__read_orig_vertex.writeAction(f"sendr2_dmlm X26 X27 X25 X22") 
  tranBFS_pull__read_orig_vertex.writeAction(f"addi X24 X24 1") 
  tranBFS_pull__read_orig_vertex.writeAction(f"add X18 X19 X28") 
  tranBFS_pull__read_orig_vertex.writeAction(f"yield") 
  
  # Writing code for event BFS_pull::update_siblings
  tranBFS_pull__update_siblings = efa.writeEvent('BFS_pull::update_siblings')
  tranBFS_pull__update_siblings.writeAction(f"entry: sli X18 X27 6") 
  tranBFS_pull__update_siblings.writeAction(f"add X16 X27 X28") 
  tranBFS_pull__update_siblings.writeAction(f"addi X28 X26 32") 
  tranBFS_pull__update_siblings.writeAction(f"evi X2 X27 BFS_pull::write_dram_return 1") 
  tranBFS_pull__update_siblings.writeAction(f"addi X18 X28 32") 
  ...
  tranBFS_pull__update_siblings.writeAction(f"__while_update_siblings_4_body: ble X18 X28 __if_update_siblings_8_post") 
  ...
  tranBFS_pull__update_siblings.writeAction(f"__if_update_siblings_8_post: sendr2_dmlm X26 X27 X25 X22") 
  ...
  tranBFS_pull__alloc_frontier.writeAction(f"entry: add X18 X19 X26") 
  tranBFS_pull__alloc_frontier.writeAction(f"evi X2 X27 BFS_pull::update_siblings_frontier 1") 
  tranBFS_pull__alloc_frontier.writeAction(f"sendr_wcont X27 X1 X8 X26") 
  tranBFS_pull__alloc_frontier.writeAction(f"yield") 
  ...
  tranBFS_pull__update_siblings_frontier.writeAction(f"entry: sli X18 X27 6") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"add X16 X27 X28") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"addi X28 X26 32") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"addi X8 X27 0") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"evi X2 X28 BFS_pull::write_dram_return 1") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"addi X18 X29 32") 
  ...
  tranBFS_pull__update_siblings_frontier.writeAction(f"__while_update_siblings_frontier_4_body: ble X18 X29 __if_update_siblings_frontier_8_post") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"__if_update_siblings_frontier_6_true: sendr_wcont X2 X1 X27 X9") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"yield") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"__if_update_siblings_frontier_8_post: sendr2_dmlm X26 X28 X25 X22") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"sendr_dmlm X27 X28 X18") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"addi X18 X18 1") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"addi X26 X26 64") 
  tranBFS_pull__update_siblings_frontier.writeAction(f"addi X27 X27 8") 
  ...
  tranBFS_pull__write_dram_return.writeAction(f"entry: subi X24 X24 1") 
  ...
  tranBFS_pull__write_dram_return.writeAction(f"sendr_wcont X26 X2 X21 X19") 
