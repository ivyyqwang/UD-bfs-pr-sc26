...
class OneDimKeyValueSet2(OneDimKeyValueSet):
...
DEBUG_FLAG      = False
MAX_MAP_THREAD_PER_LANE     = 160
MAX_REDUCE_THREAD_PER_LANE  = 58
...
OUTPUT_ARRAY_ELEMENT_SIZE = 8
OUTPUT_KVSET = MaskedOneDimKeyValueSet(name=f"{TASK_NAME}_output", element_size=OUTPUT_ARRAY_ELEMENT_SIZE, argument_size=3, mask="00000010")
