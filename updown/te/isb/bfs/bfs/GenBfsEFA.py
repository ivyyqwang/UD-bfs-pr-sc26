...
class BFS:
    ...
    def gen_update_neighbor(self):
        ...
        for k in range(DRAM_MSG_SIZE):
            ...
            if self.debug_flag:
                fetch_nbor_tran.writeAction(f"print '[DEBUG][NWID %ld] Vertex %ld sends update to vid=%ld new_dist=%ld to network_id=%ld' \
    ...
    def gen_update_dist(self):
        ...
        read_v_tran.writeAction(f"beqi {from_sibling} 1 {skip_sibling_label}")
        ...
        read_v_tran.writeAction(f"subi {self.scratch[1]} {self.scratch[0]} 1")
        ...
        if self.debug_flag:
            read_v_tran.writeAction(f"print '[DEBUG][NWID %ld] Insert vid=%ld to frontier.' {'X0'} {self.vid}")
        ...
        udp_dist_tran.writeAction(f"movir {from_sibling} 1")
